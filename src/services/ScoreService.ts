    ...
    const definitions: Omit<Badge, 'unlocked'>[] = [
      {
        ...
        name: 'İlk Adım',
        emoji: '\u2B50',
        description: 'İlk bilmeceyi çöz!',
      },
      {
        id: 'ten_solves',
        name: 'Bilmece Meraklısı',
        emoji: '\uD83E\uDDE0',
        description: '10 bilmece çöz!',
      },
      {
        id: 'fifty_solves',
        name: 'Bilmece Ustası',
        emoji: '\uD83C\uDFC6',
        description: '50 bilmece çöz!',
      },
      {
        id: 'streak_5',
        name: 'Seri Çözücü',
        emoji: '\uD83D\uDD25',
        description: '5 bilmeceyi üst üste çöz!',
      },
      {
        id: 'streak_10',
        name: 'Durdurulamaz',
        emoji: '\uD83D\uDE80',
        description: '10 bilmeceyi üst üste çöz!',
      },
      {
        id: 'score_100',
        name: 'Puan Avcısı',
